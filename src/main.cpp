...
int main(int argc, char *argv[])
{
    ...
    std::shared_ptr<Sphere> sphere1 = std::make_shared<Sphere>(glm::vec3(3.0f, 0 , -20), 2, glm::vec3(0,0,0.75f));
    rayTracer->addSphere(sphere1);

    std::shared_ptr<Sphere> sphere9 = std::make_shared<Sphere>(glm::vec3(0, 3.5f , -15), 1, glm::vec3(1,0,0));
    rayTracer->addSphere(sphere9);
  
    std::shared_ptr<Sphere> sphere2 = std::make_shared<Sphere>(glm::vec3(-3.0f, 0, -20), 2, glm::vec3(0,0,0.75f));
    rayTracer->addSphere(sphere2);

    std::shared_ptr<Sphere> sphere3 = std::make_shared<Sphere>(glm::vec3(0, -3.0f, -20), 2, glm::vec3(0.75f,0,0));
    rayTracer->addSphere(sphere3);

    std::shared_ptr<Sphere> sphere4 = std::make_shared<Sphere>(glm::vec3(0, 3.0f, -20), 2, glm::vec3(0.75f,0,0));
